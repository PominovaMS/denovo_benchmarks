...
def knapDecode(prob, preMass,tol):
    grid_size = 1
    mass_b =79.9663
    AAmasses = [0.0, 57.021464, 71.037114, 87.032028, 97.052764, 99.068414, 101.04767,  160.030649, 113.084064, 113.084064, 114.042927, 115.026943, 128.058578, 128.094963, 129.042593, 131.040485, 137.058912, 147.068414, 156.101111, 163.063329, 186.079313, 147.0354, 115.026943, 129.042594, 42.010565, 43.005814, 10000.0, 25.980265, mass_b]
    ...
    result = np.where(result == 0, 28, result - 1)
    #print("result:", result)
    sys.stdout.flush()
