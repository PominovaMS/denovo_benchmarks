...
(Based on MztabWriter from Casanovo https://github.com/Noble-Lab/casanovo/tree/main)
"""
...
class MztabWriter:
    ...
    def __init__(self, filename: str):
        ...
        self.metadata = [
            ...
            (
                "description",
                f"ContraNovo identification file "
                f"{os.path.splitext(os.path.basename(self.filename))[0]}",
            ),
            ("software[1]", f"[MS, MS:1003281, ContraNovo]"),
            (
