...
from . import utils
from .denovo import model_runner, ms_io
...
def main(
    ...
    # Make sure n_workers = 0 and doesn't cause multiprocessing errors
    print("DEBUG: N workers =", config["n_workers"])
    if n_gpus > 1:
    ...
    if mode == "denovo":
        ...
        writer = ms_io.MztabWriter(filename="./outputs.mztab")
        writer.set_metadata(
